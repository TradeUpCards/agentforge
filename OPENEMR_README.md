<!--
  This is the upstream OpenEMR README, preserved verbatim for reference.
  AgentForge's own README (the project this fork was built for) lives at
  ./README.md. CI badges below reference openemr/openemr — they describe
  upstream CI, not this fork's CI status.
-->
